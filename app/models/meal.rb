class Meal < ApplicationRecord
    ...
    def calc_percent_of_total_carbs
        return (self.total_carbohydrates.to_f / self.calc_total_nutrition.to_f * 100).round(1)
    end

    def calc_percent_of_total_proteins
        return (self.total_proteins.to_f / self.calc_total_nutrition.to_f * 100).round(1)
    end

    def calc_percent_of_total_fat
        return (self.total_fat.to_f / self.calc_total_nutrition.to_f * 100).round(1)
    end
end
